...
namespace PBBox
{
    public class PBCommands : SingleClass<PBCommands>
    {
        ...
        public void LoadAllCmd()
        {
            ...
            int methodCount = 0;
            _methodMap.Clear();
            var methodInfos = ReflectionUtils.GetAllMethodWithAtturbute<PBCommandClassAttribute, PBCommandAttribute>(_methodBindingFlag, assemblyNames: PBBoxSettings.CommandSystemInitReflectAssemblies);
